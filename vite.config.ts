...
export default defineConfig({
    ...
    build: {
        ...
        rollupOptions: {
            ...
            // Every page in views/, plus the external fragments a modal fetches
            // at runtime: index.pug is a page too, and external/externalhtml.pug
            // has to land in demo/external/ for the "Link to an HTML file" demo.
            input: [
                resolve(import.meta.dirname, "src/demo/views/*.pug"),
                resolve(import.meta.dirname, "src/demo/views/external/*.pug"),
